...
export default function CreateInputFields({ type }: CreateInputFieldsProps) {
	...
	const handleAddTag = () => {
		if (!addTag.trim()) return toast("You need to add a tag")
		setFormData({
			...formData,
	...
	const onsubmit = async (event: React.FormEvent) => {
		...
		const maxPeriod = maxPeriodCalculator(
