															...
															<table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="left" class="r10-o" style="table-layout: fixed; width: 100%;">
																<tr>
																	<td
																		...
																		"
																	>
																		<div><p style="margin: 0;">Hey there. A task was just shared to you by ${external.sharedBy.name}, ${external.sharedBy.email}. You can click the button below to see the task on coretask task manager</p></div>
																	</td>
																</tr>
															</table>
															<table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="left" class="r10-o" style="table-layout: fixed; width: 100%;">
																	...
																	>
																		<div>
																			<h1 class="default-heading1" style="margin: 0; color: #1f2d3d; font-family: arial, helvetica, sans-serif; font-size: 36px; word-break: break-word;">
																				...
																				<a href="${variables.ENV.NEXT_AUTH_URL}/${external._id}">Open Task</a>
																				</span>
																			</h1>
																		</div>
																	</td>
