...
export default function shareTask(external: any) {
  return (
    `
    <!DOCTYPE html>
    <html>
            ...
            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="600" align="center" class="r0-o" style="table-layout: fixed; width: 600px;">
              <tr>
                <td valign="top" class="r1-i" style="background-color: #ffffff;">
                    ...
                    <tr>
                      <td class="r9-i" style="padding-bottom: 20px; padding-top: 20px;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                          <tr>
                            <th width="100%" valign="top" class="r5-c" style="font-weight: normal;">
                              <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="left" class="r10-o" style="table-layout: fixed; width: 100%;">
                                <tr>
                                  <td
                                    align="center"
                                    valign="top"
                              ...
                              <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="left" class="r10-o" style="table-layout: fixed; width: 100%;">
                                <tr>
                                  <td
                                    ...
                                    "
                                  >
                                  <div><p style="margin: 0;">Hey there, ${external.sharedBy.name}, ${external.sharedBy.email} just shared you a task. Click the button below to see the task on CoreTask task manager.</p></div>
                                  </td>
                                </tr>
                              </table>
                              <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="left" class="r10-o" style="table-layout: fixed; width: 100%;">
                                <tr>
                                  <td
                                    ...
                                    style="color: #3b3f44; font-family: arial, helvetica, sans-serif; font-size: 18px; line-height: 1.5; word-break: break-word; padding-bottom: 15px; padding-top: 15px; text-align: center;"
                                  >
                                    <div>
                                      <h1 class="default-heading1" style="margin: 0; color: #1f2d3d; font-family: arial, helvetica, sans-serif; font-size: 36px; word-break: break-word;">
                                        <span style="font-family: Arial; font-size: 72px;">
                                        <a href="${variables.ENV.NEXT_AUTH_URL}/${external._id}" style="font-size: 20px; text-decoration: none; color: white; background: rgb(64, 112, 255); padding: 10px 30px; border-radius: 5px; font-weight: 100;">View Task</a>
                                        </span>
                                      </h1>
                                    </div>
                                  </td>
                  ...
                  <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="center" class="r3-o" style="table-layout: fixed; width: 100%;">
                    <tr>
                      <td class="r14-i" style="background-color: #eff2f7; padding-bottom: 20px; padding-top: 20px;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                          <tr>
                            <th width="100%" valign="top" class="r5-c" style="font-weight: normal;">
                              <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r6-o" style="table-layout: fixed; width: 100%;">
